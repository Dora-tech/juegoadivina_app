      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),  // Espaciado entre la animación y el título
            ...
            const SizedBox(height: 30),  // Separación para los otros elementos si es necesario
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PantallaJuego(numeroSecreto: generarNumeroAleatorio()),
                  ),
                );
              },
              child: const Text(
